...
def get_hours():
    if request.method == 'POST':
        ...
        if 'healthy' not in p:
            ...
            # get the cure for the disease
            cure = data[p.lower()]
            return render_template("models/plant.html", prediction = p, cure=cure, img_path = img_path)
        else:
            return render_template("models/plant.html", prediction = p, img_path = img_path)
