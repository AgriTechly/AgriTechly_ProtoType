...
with open('inputs\input_crop.json') as json_file:
...
def main():
    ...
    model_path = os.path.join(script_dir, 'models', 'CropYield.joblib')
    ...
    # save the result in the results folder
    with open(os.path.join(script_dir, 'results', 'result_crop.json'), 'w') as outfile:
